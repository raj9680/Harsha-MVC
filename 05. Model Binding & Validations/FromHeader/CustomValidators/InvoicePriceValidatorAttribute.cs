...
namespace FromHeader.CustomValidators
{
    ...
    {
        public string DefaultErrorMessage { get; set; } = "Invoice Price should be equal to the total cost of allproducts (i.e. {0}) in he order.";
        ...
        protected override ValidationResult? IsValid(object? value, ValidationContext validationContext)
        {
            if(value != null)
            {
                ...
                PropertyInfo? OtherProperty = validationContext.ObjectType.GetProperty(nameof(OrderModel.Products));
